...
export const WORKFLOW_TEMPLATES: WorkflowTemplate[] = [
  ...
  },
  {
    ...
    description: 'Ảnh đầu vào + prompt ý tưởng → tự viết kịch bản → 4 ảnh tham chiếu → video Google Omni',
    ...
    nodes: [
      ...
      },
      {
        ...
        data: { index: 3, label: 'Ảnh tham chiếu 4' },
      },
    ...
    edges: [
      ...
      { id: 'e-image-ref-4', source: 'image-1', target: 'storyboard-image-4', animated: true },
      ...
      { id: 'e-prompt-ref-4', source: 'prompt-1', target: 'storyboard-image-4', animated: true },
