...
export const WORKFLOW_TEMPLATES: WorkflowTemplate[] = [
  ...
  },
  {
    ...
    description: 'Ảnh đầu vào + prompt kịch bản → storybook OpenAI → 4 ảnh tham chiếu → video Google Omni',
    ...
    nodes: [
      ...
      },
      {
        ...
        data: { sourceStoryboardId: 'storyboard-1', index: 0, label: 'Ảnh tham chiếu 1' },
      },
      {
        id: 'storyboard-image-2',
        type: 'storyboardImage',
        position: { x: 1220, y: 200 },
        data: { sourceStoryboardId: 'storyboard-1', index: 1, label: 'Ảnh tham chiếu 2' },
      },
      {
        id: 'storyboard-image-3',
        type: 'storyboardImage',
        position: { x: 1220, y: 380 },
        data: { sourceStoryboardId: 'storyboard-1', index: 2, label: 'Ảnh tham chiếu 3' },
      },
      {
        id: 'storyboard-image-4',
        type: 'storyboardImage',
        position: { x: 1220, y: 560 },
        data: { sourceStoryboardId: 'storyboard-1', index: 3, label: 'Ảnh tham chiếu 4' },
      },
      { id: 'video-1', type: 'video', position: { x: 1530, y: 250 }, data: {} },
    ],
    edges: [
      ...
      { id: 'e-storybook-ref-1', source: 'storyboard-1', target: 'storyboard-image-1', animated: true },
      { id: 'e-storybook-ref-2', source: 'storyboard-1', target: 'storyboard-image-2', animated: true },
      { id: 'e-storybook-ref-3', source: 'storyboard-1', target: 'storyboard-image-3', animated: true },
      { id: 'e-storybook-ref-4', source: 'storyboard-1', target: 'storyboard-image-4', animated: true },
      ...
      { id: 'e-ref-4-video', source: 'storyboard-image-4', target: 'video-1', animated: true },
    ],
  },
];
