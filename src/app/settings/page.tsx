...
const providers = [
  ...
  },
  {
    ...
    placeholder: 'AIza...',
    helper: 'Dùng cho tạo video Gemini/Veo.',
  },
] as const;
...
export default function SettingsPage() {
  ...
  return (
    <AppShell>
      <Header
        title="Settings"
        subtitle="Quản lý API keys cho AI providers"
        actions={
          <button
            type="submit"
            form="api-key-settings-form"
      ...
      <main className="flex-1 overflow-y-auto p-6">
        <form id="api-key-settings-form" onSubmit={handleSave} className="max-w-5xl">
          <div
